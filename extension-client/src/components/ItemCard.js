        ...
        <Card.Body>
            <div className='card-title'>
                <div className='row'>
                    ...
                    <div className='col item-title'>
                        <div className='row'><b>{String(json.dname).toUpperCase()}</b></div>
                        <div className='row'>
                                {
                                    json.charges ?
                                        <small className='charges'>Stack Count: {json.charges}   </small>
                                        : ""
                                }
                            
                                <small className='subtitle'>Tier {json.tier} Neutral Item</small>
                        </div>
                    </div>
                </div>
            </div>
            <div className='card-text'>
                <div className='attribute'>
                    {
                        json.attrib ?
                            json.attrib.map(({ header = "", footer = "", value = "" }, idx) =>
...
const getActiveOrUseAbilities = (json, key)  => {
    return (<div className='active-abilities'>
        {
            json[key] ?
